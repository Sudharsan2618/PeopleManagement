        ...
        <DialogHeader>
          <div className="flex items-center gap-3">
            <span className={cn(
              ...
              activeReminder.outcome === "interested"
                ? "bg-red-100 text-red-600"
                : activeReminder.outcome === "qualified"
                ? "bg-purple-100 text-purple-600"
                : activeReminder.outcome === "not_interested"
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <Badge className={cn(
                  ...
                  {activeReminder.outcome === "interested" ? "Hot" : activeReminder.outcome === "qualified" ? "Visit" : activeReminder.outcome === "not_interested" ? "Cold" : "Warm"}
                </Badge>
              </div>
