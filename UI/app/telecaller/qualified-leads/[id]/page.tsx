...
export default function TelecallerQualifiedLeadDetailPage() {
  ...
  const [initPaymentMode, setInitPaymentMode] = useState("Cash")
  ...
  const qualifiedDate = lead.qualified_date
    ? (lead.qualified_date.includes("T") || lead.qualified_date.includes(" ") ? formatISTDateTime(lead.qualified_date).split(" ")[0] : lead.qualified_date)
    : (lead.updated_at ? (lead.updated_at.includes("T") || lead.updated_at.includes(" ") ? formatISTDateTime(lead.updated_at).split(" ")[0] : lead.updated_at) : "-")
    ...
    <div className="space-y-5 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <Card className="bg-white border-border shadow-sm">
          ...
          <CardContent className="px-5 pb-4">
            <Separator className="mb-3" />
            <InfoRow label="Telecaller" value={telecallerDisplay} />
      ...
      {/* Timeline & Call Activity History */}
      <ProspectTimelineHistory prospectId={lead.id} />
